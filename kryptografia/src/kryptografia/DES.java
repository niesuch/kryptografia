...
public class DES {
	...
	// początkowy klucz permutacji 64 => 56 biti
	...
	//klucz permutacji w rundzie 56 => 48
	private static int[] PC2 = { 14, 17, 11, 24, 1, 5, 3, 28, 15, 6, 21, 10,
			...
			32 };
	// klucz zmiany dla kazdej rundy
	private static int[] keyShift = { 1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2,
			2, 1 };
	// rozszerzenie permutacji dla funkcji 
